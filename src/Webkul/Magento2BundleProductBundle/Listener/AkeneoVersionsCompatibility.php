...
class AkeneoVersionsCompatibility
{
    ...
    const CLASS_ALISASE_NAMES = [
        'ProductModelInterface' => [
            ...
            '3.X'  =>  'Akeneo\Pim\Enrichment\Component\Product\Model\ProductModelInterface',
        ],
        'AkeneoVersion' => [
        ...
        'BaseFlatToStandardProduct' => [
            '2.X' => 'Pim\Component\Connector\ArrayConverter\FlatToStandard\Product',
            '3.X' => 'Akeneo\Pim\Enrichment\Component\Product\Connector\ArrayConverter\FlatToStandard\Product'
        ],
        'ArrayConverterInterface' => [
            '2.X' => 'Pim\Component\Connector\ArrayConverter\ArrayConverterInterface',
            '3.X' => 'Akeneo\Tool\Component\Connector\ArrayConverter\ArrayConverterInterface'
        ],
        'StructureArrayConversionException' => [
            '2.X' => 'Pim\Component\Connector\Exception\StructureArrayConversionException',
            '3.X' => 'Akeneo\Tool\Component\Connector\Exception\StructureArrayConversionException'
        ]
    ];
}
