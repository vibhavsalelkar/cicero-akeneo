...
define(
    ...
    function (
        ...
        return BaseForm.extend({
             ...
             */
            render: function () {
                const {quantified_associations} = this.getFormData();
                if (typeof(quantified_associations) !== 'undefined') {
            ...
            filterGroupType: function(associationTypes) {
                ...
                if(!associationTypes.length && !this.created) {
            ...
            addAssociations: function () {
                this.launchProductPicker().then((productAndProductModelIdentifiers) => {
                    let productIds = [];
                    let productModelIds = [];
                    console.log(productAndProductModelIdentifiers);
                    ...
                    FetcherRegistry
                        ...
                        .then((associationType) => {                            
                            ...
                            if(currentPatch >= '3.0') {
                                ...
                                modalObject.title = __('pim_enrich.entity.product.module.associations.manage', {
