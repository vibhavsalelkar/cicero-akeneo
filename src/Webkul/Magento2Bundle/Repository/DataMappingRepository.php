...
class DataMappingRepository extends EntityRepository implements \DatagridRepositoryInterface, \MassActionRepositoryInterface
{
    /** @var EntityManager */
    protected $em;
    ...
    {
        $qb = $this->createQueryBuilder('wdm');
    ...
    public function deleteFromIds(array $identifiers)
    {
        ...
        $qb->delete($this->entityName, 'wdm')
            ->where($qb->expr()->in('wdm.id', $identifiers));
