...
class VariantProductReader extends \DatabaseProductReader implements ItemReaderInterface, InitializableInterface, StepExecutionAwareInterface
{
    ...
    protected function getConfiguredFilters()
    {
        ...
        if (empty($identifiers)) {
            unset($filters[$index]);
            $identifiers = $this->connectorService->findIdentifiersNotEmptyParent();
