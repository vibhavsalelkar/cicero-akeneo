...
//                         .fetchByIdentifiers(this.attributes.channel)
//                         .then(function (channels) {
//                             var category_tree = [];
//                             _.each(channels, function(channel) {
//                                 category_tree.push(channel.category_tree);
//                             });
//                             category_tree = _.uniq(category_tree);

//                             return $.when(
//                                 FetcherRegistry.getFetcher('category').fetchByIdentifiers(category_tree)
...
//                                 self.$('.root').jstree(_.extend(self.config, {
//                                     json_data: {
//                                         ajax: {
//                                             dataType: 'json',
//                                             method: 'POST',
