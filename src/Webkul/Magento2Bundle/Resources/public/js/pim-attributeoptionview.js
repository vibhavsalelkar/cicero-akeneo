define(
    [
        ...
        'oro/loading-mask',
        'pim/dialog',
        'magento2/template/attribute-option/index',
        'magento2/template/attribute-option/edit',
        'magento2/template/attribute-option/show',
        'oro/messenger',
    ...
    function (
        ...
        var EditableItemView = Backbone.View.extend({
            ...
            updateModel: function () {
                ...
                this.setReady(false); 
                $.ajax({
                    url: Routing.generate('webkul_magento2_media_rest_post'),
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    cache: false,
                ...
                .done(function (data) {
                    if(data) {
                        ...
                        var attributes = this.loadModelFromView().attributes;
